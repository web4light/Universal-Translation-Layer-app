...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  void initState() {
    ...
    _webhookUrlController = TextEditingController(text: settings.n8nUrl);
  }
      ...
      child: Column(
        ...
        children: [
          ...
          TextField(
            ...
            onChanged: (value) => settings.setN8nUrl(value),
          ),
        ],
      ),
    );
      ...
      child: Column(
        ...
        children: [
          ...
          DropdownButtonFormField<String>(
            ...
            onChanged: (value) {
              if (value != null) settings.setSelectedLanguage(value);
            },
          ),
        ],
      ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          Text('Max RAM Share: ${settings.maxRamShareMb} MB', style: const TextStyle(color: Colors.white70, fontSize: 13)),
          Slider(
            value: settings.maxRamShareMb.toDouble(),
            min: 256,
            max: 4096,
            divisions: 15,
            activeColor: Colors.cyanAccent,
            inactiveColor: Colors.white12,
            label: '${settings.maxRamShareMb} MB',
            onChanged: (v) => settings.setMaxRamShareMb(v.toInt()),
          ),
        ],
      ),
    );
  ...
  Widget _buildAboutSection(SettingsService settings) {
    return Container(
      ...
      child: Column(
        children: [
          _buildAboutRow('App Version', '0.1.0'),
          const Divider(color: Colors.white12, height: 20),
          _buildAboutRow('Ada/SPARK Binary', '/home/pj/Universal-Translation-Layer/bin/'),
          const Divider(color: Colors.white12, height: 20),
